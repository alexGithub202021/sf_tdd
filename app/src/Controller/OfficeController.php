...
class OfficeController extends AbstractController
{
    ...
    /**
     * @Route("/{idoffice}", name="office_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idoffice}/edit", name="office_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{idoffice}", name="office_delete", methods={"DELETE"})
     */
    public function delete(Request $request, Office $office): Response
    {
        if ($this->isCsrfTokenValid('delete' . $office->getIdoffice(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
